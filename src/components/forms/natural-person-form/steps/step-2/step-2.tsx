...
import { type AllNaturalPersonFormKeys } from '../../four-step-form'
...
interface Step2Props {
  ...
  registrationAddressFields: AllNaturalPersonFormKeys[]
  residenceAddressFieldsWithSwitch: AllNaturalPersonFormKeys[]
}
