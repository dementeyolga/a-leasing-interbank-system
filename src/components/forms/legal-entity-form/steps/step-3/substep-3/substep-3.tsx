  ...
  return (
    <FormWrapper>
      ...
      <FormTextareaWrapper
        ...
        tooltip="Сведения об учредителях (участниках), иных лицах, которые имеют право давать обязательные для организации указанния (Наименование организации, страна регистрации и  юр.адрес/Ф.И.О., гражданство, место жительства или пребывания, доля в УФ)"
      />

      <FormTextareaWrapper
        name="foundersWithLargeUVShareInformation"
        label="Имеющие более 25% доли УФ учредители имеют более 25% доли УФ в иной организации?"
        tooltip="Являются ли учредители(участники) организации, имеющие долю в УФ более 25%, собственники или бенефициарные владельцы учредителями или участниками других организации с долей  в УФ более 25%, собственниками или руководителями других организаций. Если да, то указать организацию, страну регистрации организации, долю в УФ."
      />
    </FormWrapper>
  )
}
